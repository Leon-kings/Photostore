...
// // Mock data for dashboard (keeping essential stats only)
// const dashboardData = {
//   totalViews: 154789,
//   totalLikes: 45678,
//   totalComments: 12345,
//   totalShares: 8765,
//   totalAlbums: 0, // Set to 0
//   totalImages: 0, // Set to 0
//   totalPhotographers: 12,
//   totalVisitors: 23456,
//   averageTimeSpent: '4m 32s',
//   bounceRate: '32%',
...
//   return (
//     <div className="min-h-screen mt-10 w-full bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
...
//               {/* Albums Grid */}
//               <div className="text-center py-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-purple-500/30">
//                 <FolderIcon className="text-6xl text-gray-600 mb-4" />
//                 <h3 className="text-xl text-gray-400 mb-2">No Albums Found</h3>
//                 <p className="text-gray-500 mb-4">Get started by creating your first album</p>
//                 <button className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity inline-flex items-center gap-2">
//                   <AddIcon /> Create New Album
//                 </button>
//               </div>
//             </motion.div>
//           )}
  ...
  return (
    <div className="min-h-screen mt-10 w-full bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : ''}`}>
        ...
        {/* Header */}
        <header className="bg-gray-900/50 backdrop-blur-sm border-b border-purple-500/30 sticky top-0 z-20">
          <div className="flex items-center justify-between px-4 xsm:px-6 py-3 xsm:py-4">
            <div className="flex items-center gap-2 xsm:gap-4">
              {/* Mobile Menu Button */}
              {!sidebarOpen && (
                <button
                ...
                >
                  <MenuIcon className="text-lg xsm:text-xl" />
                </button>
              )}
              
              <h2 className="text-base xsm:text-lg sm:text-xl font-semibold text-white capitalize truncate max-w-[150px] xsm:max-w-[200px] sm:max-w-full">
                {activeTab} Dashboard
              </h2>
            </div>
            ...
            <div className="flex items-center gap-2 xsm:gap-4">
              ...
              <div className="hidden sm:block relative">
                <SearchIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm xsm:text-base" />
                <input
                  type="text"
                  placeholder="Search..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="pl-9 xsm:pl-10 pr-3 xsm:pr-4 py-1.5 xsm:py-2 w-32 xsm:w-40 md:w-48 lg:w-64 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 text-sm xsm:text-base"
                />
              </div>

              {/* Mobile Search Button */}
              <button className="sm:hidden p-1.5 xsm:p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                <SearchIcon className="text-base xsm:text-lg" />
              </button>

              {/* Refresh button */}
              <button
                onClick={handleRefresh}
                className="p-1.5 xsm:p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors"
              >
                <RefreshIcon className={`text-base xsm:text-lg ${loading ? 'animate-spin' : ''}`} />
              </button>

              {/* Notifications */}
              <div className="relative">
                <button className="p-1.5 xsm:p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                  <div className="absolute top-1.5 xsm:top-2 right-1.5 xsm:right-2 w-1.5 xsm:w-2 h-1.5 xsm:h-2 bg-pink-500 rounded-full"></div>
                  <InfoIcon className="text-base xsm:text-lg" />
                </button>
              </div>

              {/* User menu */}
              <button className="flex items-center gap-2 xsm:gap-3 p-1.5 xsm:p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                <div className="w-6 h-6 xsm:w-7 xsm:h-7 md:w-8 md:h-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center">
                  <span className="text-white text-xs xsm:text-sm md:text-sm font-semibold">AD</span>
                </div>
        ...
        <div className="p-3 xsm:p-4 sm:p-5 md:p-6">
          ...
          {activeTab === 'overview' && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="space-y-4 xsm:space-y-5 md:space-y-6"
            >
              {/* Stats Cards */}
              <div className="grid grid-cols-1 xsm:grid-cols-2 lg:grid-cols-4 gap-3 xsm:gap-4 md:gap-5 lg:gap-6">
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30"
                >
                  <div className="flex items-center justify-between mb-2 xsm:mb-3 md:mb-4">
                    <div className="w-8 h-8 xsm:w-9 xsm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-pink-500/20 rounded-lg flex items-center justify-center">
                      <VisibilityIcon className="text-pink-400 text-base xsm:text-lg md:text-xl lg:text-2xl" />
                    </div>
                    <TrendingUpIcon className="text-green-400 text-sm xsm:text-base md:text-lg" />
                  </div>
                  <h3 className="text-gray-400 text-xs xsm:text-sm">Total Views</h3>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalViews.toLocaleString()}</p>
                  <p className="text-green-400 text-xs xsm:text-sm mt-1 xsm:mt-2">↑ 12% from last month</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-between mb-2 xsm:mb-3 md:mb-4">
                    <div className="w-8 h-8 xsm:w-9 xsm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-purple-500/20 rounded-lg flex items-center justify-center">
                      <ThumbUpIcon className="text-purple-400 text-base xsm:text-lg md:text-xl lg:text-2xl" />
                    </div>
                    <TrendingUpIcon className="text-green-400 text-sm xsm:text-base md:text-lg" />
                  </div>
                  <h3 className="text-gray-400 text-xs xsm:text-sm">Total Likes</h3>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalLikes.toLocaleString()}</p>
                  <p className="text-green-400 text-xs xsm:text-sm mt-1 xsm:mt-2">↑ 8% from last month</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-between mb-2 xsm:mb-3 md:mb-4">
                    <div className="w-8 h-8 xsm:w-9 xsm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-blue-500/20 rounded-lg flex items-center justify-center">
                      <CommentIcon className="text-blue-400 text-base xsm:text-lg md:text-xl lg:text-2xl" />
                    </div>
                    <TrendingDownIcon className="text-red-400 text-sm xsm:text-base md:text-lg" />
                  </div>
                  <h3 className="text-gray-400 text-xs xsm:text-sm">Comments</h3>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalComments.toLocaleString()}</p>
                  <p className="text-red-400 text-xs xsm:text-sm mt-1 xsm:mt-2">↓ 3% from last month</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center justify-between mb-2 xsm:mb-3 md:mb-4">
                    <div className="w-8 h-8 xsm:w-9 xsm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-green-500/20 rounded-lg flex items-center justify-center">
                      <PeopleIcon className="text-green-400 text-base xsm:text-lg md:text-xl lg:text-2xl" />
                    </div>
                    <TrendingUpIcon className="text-green-400 text-sm xsm:text-base md:text-lg" />
                  </div>
                  <h3 className="text-gray-400 text-xs xsm:text-sm">Visitors</h3>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalVisitors.toLocaleString()}</p>
                  <p className="text-green-400 text-xs xsm:text-sm mt-1 xsm:mt-2">↑ 15% from last month</p>
                </motion.div>
              </div>

              {/* Charts Section */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 xsm:gap-4 md:gap-5 lg:gap-6">
                {/* Views Over Time */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30"
                >
                  <div className="flex flex-col xsm:flex-row xsm:items-center justify-between gap-2 xsm:gap-0 mb-4 xsm:mb-5 md:mb-6">
                    <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white">Views Over Time</h3>
                    <select
                      value={timeRange}
                      onChange={(e) => setTimeRange(e.target.value)}
                      className="bg-gray-700 text-white text-xs xsm:text-sm rounded-lg px-2 xsm:px-3 py-1.5 xsm:py-2 border border-gray-600 focus:outline-none focus:border-purple-500 w-full xsm:w-auto"
                    >
                      <option value="week">Last 7 days</option>
                      <option value="month">Last 30 days</option>
                      <option value="year">Last 12 months</option>
                  ...
                  {/* Simple bar chart representation */}
                  <div className="h-48 xsm:h-52 md:h-56 lg:h-64 flex items-end justify-between gap-1 xsm:gap-2">
                    {dashboardData.viewsOverTime.slice(-7).map((item, index) => (
                      <div key={index} className="flex-1 flex flex-col items-center">
                        <div 
                          className="w-full bg-gradient-to-t from-pink-500 to-purple-500 rounded-t-lg transition-all hover:from-pink-600 hover:to-purple-600"
                          style={{ height: `${(item.views / 40000) * (index === 0 ? 150 : index === 1 ? 160 : 200)}px` }}
                        />
                        <p className="text-[10px] xsm:text-xs text-gray-400 mt-1 xsm:mt-2 rotate-45 xsm:rotate-0 origin-left xsm:origin-center">
                          {item.date.slice(-2)}
                        </p>
                      </div>
                    ))}
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30"
                >
                  <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Device Breakdown</h3>
                  <div className="space-y-3 xsm:space-y-4">
                    {dashboardData.deviceBreakdown.map((device, index) => (
                      <div key={index}>
                        <div className="flex justify-between text-xs xsm:text-sm mb-1">
                          <span className="text-gray-400">{device.device}</span>
                          <span className="text-white font-semibold">{device.percentage}%</span>
                        </div>
                        <div className="w-full h-1.5 xsm:h-2 bg-gray-700 rounded-full overflow-hidden">
                          <div 
                            className="h-full bg-gradient-to-r from-pink-500 to-purple-500 rounded-full"
                            style={{ width: `${device.percentage}%` }}
                          />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 xsm:gap-4 md:gap-5 lg:gap-6">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30"
                >
                  <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Popular Albums</h3>
                  <div className="text-center py-6 xsm:py-8 text-gray-400 text-sm xsm:text-base">
                    No albums available
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30"
                >
                  <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Recent Activity</h3>
                  <div className="text-center py-6 xsm:py-8 text-gray-400 text-sm xsm:text-base">
                    No recent activity
                  </div>
                </motion.div>
          ...
          {activeTab === 'albums' && (
            ...
            >
              {/* Filters */}
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                <div className="flex flex-col xsm:flex-row flex-wrap items-start xsm:items-center gap-3 xsm:gap-4">
                  <div className="w-full xsm:flex-1 min-w-[200px]">
                    <input
                      type="text"
                      placeholder="Search albums or photographers..."
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="w-full px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 text-sm xsm:text-base"
                    />
                  </div>
                  
                  <div className="flex flex-wrap gap-2 xsm:gap-3 w-full xsm:w-auto">
                    <select
                      value={filterStatus}
                      onChange={(e) => setFilterStatus(e.target.value)}
                      className="flex-1 xsm:flex-none px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm xsm:text-base"
                    >
                      <option value="all">All Status</option>
                      <option value="published">Published</option>
                      <option value="draft">Draft</option>
                    ...
                    <button className="flex-1 xsm:flex-none px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-1 xsm:gap-2 text-sm xsm:text-base">
                      <AddIcon className="text-base xsm:text-lg" /> 
                      <span className="hidden xsm:inline">New Album</span>
                      <span className="xsm:hidden">New</span>
                    </button>
                  </div>
                </div>
              </div>
              ...
              {/* Albums Grid */}
              <div className="text-center py-8 xsm:py-10 md:py-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl border border-purple-500/30">
                <FolderIcon className="text-4xl xsm:text-5xl md:text-6xl text-gray-600 mb-3 xsm:mb-4" />
                <h3 className="text-lg xsm:text-xl text-gray-400 mb-2">No Albums Found</h3>
                <p className="text-sm xsm:text-base text-gray-500 mb-3 xsm:mb-4">Get started by creating your first album</p>
                <button className="px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity inline-flex items-center gap-1 xsm:gap-2 text-sm xsm:text-base">
                  <AddIcon /> Create New Album
                </button>
              </div>
            </motion.div>
          ...
          {activeTab === 'analytics' && (
            ...
            >
              ...
              <div className="grid grid-cols-1 xsm:grid-cols-2 lg:grid-cols-4 gap-3 xsm:gap-4 md:gap-5 lg:gap-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <div className="flex items-center gap-2 xsm:gap-3 mb-1 xsm:mb-2">
                    <ScheduleIcon className="text-blue-400 text-base xsm:text-lg" />
                    <h3 className="text-gray-400 text-xs xsm:text-sm">Avg. Time Spent</h3>
                  </div>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.averageTimeSpent}</p>
                </div>

                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <div className="flex items-center gap-2 xsm:gap-3 mb-1 xsm:mb-2">
                    <PeopleIcon className="text-green-400 text-base xsm:text-lg" />
                    <h3 className="text-gray-400 text-xs xsm:text-sm">Total Visitors</h3>
                  </div>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalVisitors.toLocaleString()}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <div className="flex items-center gap-2 xsm:gap-3 mb-1 xsm:mb-2">
                    <PhotoCameraIcon className="text-purple-400 text-base xsm:text-lg" />
                    <h3 className="text-gray-400 text-xs xsm:text-sm">Total Photographers</h3>
                  </div>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.totalPhotographers}</p>
                </div>

                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <div className="flex items-center gap-2 xsm:gap-3 mb-1 xsm:mb-2">
                    <ShowChartIcon className="text-pink-400 text-base xsm:text-lg" />
                    <h3 className="text-gray-400 text-xs xsm:text-sm">Bounce Rate</h3>
                  </div>
                  <p className="text-lg xsm:text-xl md:text-2xl font-bold text-white">{dashboardData.bounceRate}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 xsm:gap-4 md:gap-5 lg:gap-6">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Top Photographers</h3>
                  <div className="space-y-3 xsm:space-y-4">
                    {dashboardData.topPhotographers.map((photographer, index) => (
                      <div key={photographer.id} className="flex items-center justify-between">
                        <div className="flex items-center gap-2 xsm:gap-3">
                          <div className="w-6 h-6 xsm:w-7 xsm:h-7 md:w-8 md:h-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold text-xs xsm:text-sm">
                            {photographer.name.charAt(0)}
                          </div>
                          <div>
                            <p className="text-white text-xs xsm:text-sm md:text-base font-medium">{photographer.name}</p>
                            <p className="text-[10px] xsm:text-xs text-gray-400">{photographer.albums} albums • {photographer.images} images</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="text-pink-400 text-xs xsm:text-sm md:text-base font-semibold">{photographer.views.toLocaleString()}</p>
                          <p className="text-[10px] xsm:text-xs text-gray-400">views</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {/* Location Breakdown */}
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                  <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Top Countries</h3>
                  <div className="space-y-3 xsm:space-y-4">
                    {dashboardData.locationBreakdown.map((location, index) => (
                      <div key={index}>
                        <div className="flex justify-between text-xs xsm:text-sm mb-1">
              ...
              {/* Recent Uploads */}
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">Recent Uploads</h3>
                <div className="text-center py-6 xsm:py-8 text-gray-400 text-sm xsm:text-base">
                  No recent uploads
                </div>
              </div>
          ...
          {activeTab === 'settings' && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="max-w-2xl mx-auto space-y-4 xsm:space-y-5 md:space-y-6"
            >
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xsm:rounded-xl p-3 xsm:p-4 md:p-5 lg:p-6 border border-purple-500/30">
                <h3 className="text-sm xsm:text-base md:text-lg font-semibold text-white mb-4 xsm:mb-5 md:mb-6">General Settings</h3>
                
                <div className="space-y-3 xsm:space-y-4">
                  <div>
                    <label className="block text-gray-400 text-xs xsm:text-sm mb-1 xsm:mb-2">Gallery Title</label>
                    <input
                      type="text"
                      defaultValue="Visual Stories"
                      className="w-full px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm xsm:text-base"
                    />
                  </div>

                  <div>
                    <label className="block text-gray-400 text-xs xsm:text-sm mb-1 xsm:mb-2">Description</label>
                    <textarea
                      rows="3"
                      defaultValue="Capturing breathtaking moments from the most beautiful places on Earth"
                      className="w-full px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm xsm:text-base"
                  ...
                  <div>
                    <label className="block text-gray-400 text-xs xsm:text-sm mb-1 xsm:mb-2">Albums Per Page</label>
                    <select className="w-full px-3 xsm:px-4 py-1.5 xsm:py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm xsm:text-base">
                      <option>3</option>
                      <option>6</option>
                      <option>9</option>
                      <option>12</option>
                  ...
                  <button className="w-full xsm:w-auto px-4 xsm:px-6 py-2 xsm:py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity text-sm xsm:text-base">
                    Save Changes
                  </button>
                </div>
              </div>
